 ...
 * on a 3 semaphores , 2 pour controller l'attente dans put (pour qu'une place soit disponible dans le buffer)
 * et get (on attend qu'au moins un element soit ajouter au buffer)
 * 
 * Ainsi qu'une autre semaphore pour pour assurer qu'une seule thread rentre dans le section 
 * critique a la fois
 * 
 */
